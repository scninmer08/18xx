          ...
          companies.concat([
            {
              ...
              desc: 'During the “Issue a Share” step, it may close this company to issue a share for '\
                    'double its current share price. If the corporation starts as or converts to a '\
            ...
            },
            {
              ...
              value: 0,
              revenue: 0,
              desc: 'When the corporation starts, it receives one additional free token. This company then closes.',
              color: nil,
              meta: { type: :private, class: :A },
              abilities: [
                {
            ...
            },
            {
              ...
              desc: "At any time during the corporation's operating turn, it may close this company to place "\
                    "0an available token from the corporation's charter in Chicago (H3) in the GTL slot. "\
